"""Servicio de inferencia del sub-modelo `colsign_lstm_norm_bi_asimetrico_45_154`.

Clasifica UNA seña dentro del grupo **'Grupo Dinámico Bimanual Asimétrico'**
(las dos manos hacen movimientos diferentes, 39 clases).

Se invoca cuando el modelo raíz determinó que la seña pertenece al
grupo bimanual asimétrico, o bien directamente desde un endpoint dedicado.
...
GROUP_NAME = "Grupo Dinámico Bimanual Asimétrico"
...
def predict_one(
    ...
    """Predice la seña específica para una secuencia del Grupo Bimanual Asimétrico.
