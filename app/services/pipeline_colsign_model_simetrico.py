"""Servicio de inferencia del sub-modelo `colsign_lstm_norm_bi_simetrico_45_154`.

Clasifica UNA seña dentro del grupo **'Grupo Dinámico Bimanual Simétrico'**
(las dos manos hacen el mismo movimiento espejado, 30 clases).

Se invoca cuando el modelo raíz determinó que la seña pertenece al
grupo bimanual simétrico, o bien directamente desde un endpoint dedicado.
...
GROUP_NAME = "Grupo Dinámico Bimanual Simétrico"
...
def predict_one(
    ...
    """Predice la seña específica para una secuencia del Grupo Bimanual Simétrico.
