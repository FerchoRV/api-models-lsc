"""Servicio de inferencia del sub-modelo `colsign_lstm_norm_unimanual_45_154_v2`.

Clasifica UNA seña dentro del grupo **'Grupo Dinámico Unimanual'**
(señas que se ejecutan con una sola mano en movimiento, 64 clases).

Se invoca cuando el modelo raíz determinó que la seña pertenece al
grupo unimanual, o bien directamente desde un endpoint dedicado.
...
GROUP_NAME = "Grupo Dinámico Unimanual"
...
def predict_one(
    ...
    """Predice la seña específica para una secuencia del Grupo Unimanual.
